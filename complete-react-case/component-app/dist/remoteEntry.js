...
var moduleMap = {
	...
	"./NavBar": () => {
		return Promise.all([__webpack_require__.e("webpack_container_remote_lib-app_react"), __webpack_require__.e("src_NavBar_jsx")]).then(() => (() => ((__webpack_require__(/*! ./src/NavBar.jsx */ "./src/NavBar.jsx")))));
	}
};
